...
Given(
  "existe um usuário cadastrado com os seguintes dados:",
...
Given(
  "que eu envio uma requisição de login sem o campo {string}",
  function (campo) {
    this.requestData = {
...
Then(
  "pode conter um dos valores: {string}, {string}, {string}",
  function (msg1, msg2, msg3) {
...
When(
  "eu envio {int} requisições POST para {string}",
